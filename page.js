...
(function(){
  ...
  if(page==='galerie.html'){
    ...
    const galleryImages=['exterior-wide.webp','35314198-Original.jpg','Fischbacher_Chalet_innen_2017 (3).jpg','Fischbacher_Chalet_innen_2017-(11).jpg','living.webp','kitchen.webp','bathroom-sauna.webp','Rezeption.jpg','Codex-Bild 17. Sept. 2026, 15_33_10.jpg','hero-summer.webp','25-flachau-sommer-wandern-berge-18.jpg','20-flachau-sommer-e-mountainbike-7.jpg','winter-page-hero.jpg','IMG_5188.JPG','25-flachau-winter-ski-urlaub-outdoor-4.jpg','Kinderspielplatz.jpg','Foto 24.07.26, 09 36 33(1).png','Foto 24.07.26, 09 36 34(1).png','Foto 24.07.26, 11 07 55(1).png','Foto 02.06.26, 12 01 02(3).jpg','Detail-Musistadl-Eingang.jpg','Terasse-1.jpg','Flachauer-Gutshof_September_2k25_print-48.jpg','Flachauer-Gutshof_September_2k25_print-91.jpg','Flachauer Gutshof_September_2k25_print-73.jpg','Flachauer Gutshof_September_2k25_print-37.jpg','Foto-16.09.26,-14-10-12.jpg','lage.jpg'];
    galleryImages.push('_WRO8231.jpg','_WRO8236.jpg','1.jpg','2.jpg','18-flachau-sommer-card-beach-volleyball-1.jpg','18-flachau-sommer-card-erlebniswandern-1.jpg','18-flachau-sommer-card-kinderspiel-foot-darts-1.jpg','18-flachau-sommer-card-lagerfeuer-1.jpg','26-flachau-sommer-wandern-hüttenwanderung-franzfischerhütte-21.jpg','25-flachau-winter-ski-urlaub-17.jpg','35314193-1280w.jpg','Alpenchalet1_filter.jpg','bathroom.jpg','bedroom-main.jpg','chalet-4-bedroom-bunk.jpg','chalet-5-bedroom-roses.jpg','ChatGPT-Image-16.-Sept.-2026,-13_13_45.png','direkt-an-der-piste.jpg','Fischbacher_Chalet_innen_2017 (12).jpg','Fischbacher_Chalet_innen_2017 (13).jpg','Fischbacher_Chalet_innen_2017 (14).jpg','Flachauer Gutshof_September_2k25_print-74.jpg','IMG_20210315_113003.jpg','IMG_5174.JPG','kitchen.jpg','living.jpg','restaurant-dining-detail.webp','restaurant-dining-plate.jpg','restaurant-gutshof-sommer.jpg','restaurant-gutshof-winter-v2.webp','restaurant-musistadl-eingang.jpg','unsere-chalets-roses.jpg','winter-card.jpg','Zentrale-Lage.jpg');
    const gallery=document.querySelector('.gallery-full');
    if(gallery){const current=[...gallery.querySelectorAll('[data-full]')];galleryImages.forEach((src,index)=>{let item=current[index];if(!item){item=document.createElement('button');item.type='button';gallery.append(item);item.addEventListener('click',()=>{const image=modal?.querySelector('img');if(image){image.src=item.dataset.full;modal.classList.add('open')}})}const path=`assets/images/${src}`;item.dataset.full=path;let img=item.querySelector('img');if(!img){img=document.createElement('img');img.loading='lazy';img.decoding='async';item.append(img)}img.src=path;img.alt='Flachauer Alpenchalets'});current.slice(galleryImages.length).forEach(item=>item.remove())}
  }
})();
